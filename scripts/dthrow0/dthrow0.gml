		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 15;
					var _hitbox = hitbox_create_targetbox(10, 16, 0.4, 0.4, 1, 5, 0, 3, 270, 1, HITBOX_SHAPE.circle, 0, grabbed_id);
			...
			case 1:
				...
				if (attack_frame % 2 == 0 && attack_frame != 0)
					...
					var _hitbox = hitbox_create_targetbox(10, 16, 0.4, 0.4, 1, 5, 0, 5, 270 + (attack_frame * 100), 1, HITBOX_SHAPE.circle, 0, grabbed_id);
					_hitbox.knockback_state = PLAYER_STATE.is_grabbed;
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 15;
					var _hitbox = hitbox_create_melee(10, 16, 0.4, 0.4, 5, 14, 0.3, 10, 75, 1, HITBOX_SHAPE.circle, 1);
