		...
		switch(_phase)
			...
			case 2:
				...
				if (attack_frame % 3 == 0 && attack_frame != 0)
					...
					hitbox_create_magnetbox(0,0,0.8,0.8,1,5,abs(hsp)*4,vsp*3,7,3,HITBOX_SHAPE.circle,0);
					}
				...
				if (attack_frame==0)
					...
					//Hitbox
					var _hitbox = hitbox_create_melee(35,0,0.6,0.7,10,9,0.8,15,65,20,HITBOX_SHAPE.circle,1);
