		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					//Drag hitbox
					var _hitbox = hitbox_create_magnetbox(-20, 14, 0.5, 0.5, 1, 1, -20, 2, 20, 14, HITBOX_SHAPE.square, 0);
			...
			case 1:
				{
				//Move the grabbed opponent
				if (attack_frame > 30) then grab_snap_move();
				...
				if (attack_frame == 30)
					...
					speed_set(0, 0, false, false);
					anim_frame = 7;
					var _hitbox = hitbox_create_melee(-22, 0, 1, 0.7, 9, 13, 0.6, 4, 135, 7, HITBOX_SHAPE.circle, 1);
