		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					if (!on_ground())
						{
						var _hitbox = hitbox_create_melee(0, 0, 1, 1, 3, 4, 0.5, 2, 17, 3, HITBOX_SHAPE.circle, 0, FLIPPER.from_player_center);
						...
						{
						var _hitbox = hitbox_create_melee(0, 0, 1, 1, 3, 5, 0.35, 2, 50, 3, HITBOX_SHAPE.circle, 0, FLIPPER.from_player_center_horizontal);
						_hitbox.hit_fx_style = HIT_FX.normal_weak;
						_hitbox.hitlag_scaling = 0;
						}
					}
