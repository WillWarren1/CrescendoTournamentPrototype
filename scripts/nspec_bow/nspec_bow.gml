		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame <= 34 && !button_hold(INPUT.special))
					...
					var _proj = hitbox_create_projectile_custom(obj_nspec_bow_arrow, 24, 0, 0.2, 0.2, _damage, _kb, _scaling, 45, 180, HITBOX_SHAPE.circle, _hsp, 0, FLIPPER.sakurai);
					...
					_proj.hit_fx_style = _fully_charged ? [HIT_FX.explosion, HIT_FX.slash_medium] : HIT_FX.slash_medium;
