		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 25;
					var _hitbox = hitbox_create_melee(16, -32, 0.6, 0.6, 1, 6, 0, 1, 45, 26, HITBOX_SHAPE.circle, 0, FLIPPER.autolink_center);
			...
			case 1:
				...
				if (attack_frame == 2)
					{
					anim_frame = 12;
					var _hitbox = hitbox_create_melee(0, 0, 1.6, 1.6, 5, 6, 0.7, 10, 50, 3, HITBOX_SHAPE.circle, 1, FLIPPER.sakurai);
