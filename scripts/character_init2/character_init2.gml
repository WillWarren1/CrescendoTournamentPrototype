...
function character_init2() {
	...
	my_attacks[? "DashA" ] = dash_attack_mewtwo;
	...
	my_sprites[? "Entrance"	] = anim_define(spr_entrance2, anim_define_ext(spr_idle2, 0, 0.6));
	my_sprites[? "Idle"		] = anim_define_ext(spr_idle2, 0, 0.6);
