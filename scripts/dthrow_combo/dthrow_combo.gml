		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 13;
					var _hitbox = hitbox_create_targetbox(0, 0, 1, 1, 7, 8, 0.6, 7, 65, 1, HITBOX_SHAPE.square, 0, grabbed_id);
					_hitbox.hit_fx_style = HIT_FX.normal_medium;
					_hitbox.hit_sfx = [snd_hit_weak, snd_hit_weak2];
					_hitbox.di_angle = 0;
					var _fx = fx_create(spr_dust_impact, 1, 0, 21, x, bbox_bottom + 1, 1, 90, "FX_Layer_Below");
