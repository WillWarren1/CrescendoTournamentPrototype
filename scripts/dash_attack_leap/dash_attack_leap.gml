	...
	if (run)
		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0 && button_hold(INPUT.attack, 0))
					{
					charge++;
					}
				if (attack_frame == 0 && (!button_hold(INPUT.attack, 0) || charge >= 15))
					{
					attack_phase++;
					attack_frame = 13;
					}
			...
			case 1:
				...
				if (attack_frame == 11)
					...
					var _hitbox = hitbox_create_melee(4, 8, 0.3, 0.7, 9, 5, 1, 10, 315, 3, HITBOX_SHAPE.rotation, 0);
