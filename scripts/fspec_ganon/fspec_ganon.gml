		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 15;
					hitbox_create_detectbox(32, 0, 0.6, 0.6, 15, HITBOX_SHAPE.square, 0);
			...
			case 1:
				...
				//VFX
				fx_create_color(spr_fspec_ganon_trail, 1, 0, 17, x + 32 * facing, y -15 + dcos(attack_frame * 10) * 15, 2, irandom(360));
			...
			case 3:
				...
				if (attack_frame == 18)
					{
					anim_frame = 15;
					var _hitbox = hitbox_create_melee(32, -16, 0.5, 0.5, 12, 10, 0, 5, 270, 1, HITBOX_SHAPE.square, 1);
					_hitbox.hit_sfx = snd_hit_blast2;
					_hitbox.hit_fx_style = [HIT_FX.explosion, HIT_FX.magic];
					_hitbox.di_angle = 0;
					}
			...
			case 4:
				...
				//VFX
				fx_create_color(spr_fspec_ganon_trail, 1, 0, 17, x + 38 * facing, y + 28, 2, irandom(360), "FX_Layer_Below");
				
				if (on_ground())
					{
					attack_phase++;
					attack_frame = 20;
					var _hitbox = hitbox_create_melee(16, 16, 1, 0.4, 15, 5, 1, 15, 60, 4, HITBOX_SHAPE.square, 1);
