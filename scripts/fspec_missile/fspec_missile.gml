		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 10;
					var _proj = hitbox_create_projectile_custom(obj_fspec_missile_projectile, 30, 0, 0.4, 0.4, 2, 4, 0.3, 90, 300, HITBOX_SHAPE.circle, 0, 0);
					_proj.base_hitlag = 1;
					_proj.hit_fx_style = HIT_FX.normal_medium;
					if (facing == 1)
			...
			case 1:
				...
				if (attack_frame == 0 && !button_hold(INPUT.special, 0))
					{
					if (on_ground())
						{
