...
function character_init1() {
	...
	//Attacks
	my_attacks[? "Jab"	 ] = jab0;
	my_attacks[? "DashA" ] = dash_attack_corrin;
	...
	my_attacks[? "Nair"	 ] = nair_toon_link;
	...
	my_sprites[? "Entrance"	] = anim_define(spr_entrance1, anim_define_ext(spr_idle1, 0, 0.3));
	my_sprites[? "Idle"		] = anim_define_ext(spr_idle1, 0, 0.3);
	...
	my_sprites[? "DJumpFall"] = anim_define(spr_djump_rise0, anim_define(spr_jump_fall0));
