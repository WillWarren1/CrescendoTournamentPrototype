		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					var _hitbox = hitbox_create_melee(15, -2, 1.3, 0.8, 20, _attack_power, 1.3, 30, 35, 5, HITBOX_SHAPE.circle, 0);
					_hitbox.hit_sfx = snd_hit_explosion;
					_hitbox.hit_fx_style = [HIT_FX.normal_strong, HIT_FX.emphasis];
