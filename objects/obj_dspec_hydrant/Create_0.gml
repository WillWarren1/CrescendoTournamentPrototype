...
_s.water_time = 0;
_s.angle = 0;
_s.palette_sprite = spr_palette_random;
_s.player_color = 0;
...
//Drop hitbox object
_ids.drop_hitbox = hitbox_create_melee(0, 0, 0.5, 1, 8, 8, 1, 10, 45, 360, HITBOX_SHAPE.square, 0, FLIPPER.from_hitbox_center_horizontal);
...
var _f = flags_create(FLAG.solid);
